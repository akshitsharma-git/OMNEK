...
export default function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState("videos"); // "videos" or "about"
    ...
    return (
      <div className={`h-screen flex items-center justify-center ${darkMode ? 'bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900' : 'bg-gradient-to-br from-blue-50 via-white to-blue-50'}`}>
        <div className="text-center space-y-4">
          ...
          <p className={`font-medium tracking-wide ${darkMode ? 'text-slate-300' : 'text-slate-700'}`}>Loading profile</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900">
        <div className="text-center">
          <p className="text-red-400 text-lg mb-4">{error || "User not logged in"}</p>
          <button
    ...
    <div className={darkMode ? "min-h-screen" : "min-h-screen"}>
      ...
      <div style={{ 
        ...
        <section className="max-w-[1400px] mx-auto px-8 py-8">
          <div className="profile-header rounded-3xl p-8 mb-8" style={{
            background: darkMode ? '#1e293b' : 'white',
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-green-500 rounded-full border-4" style={{
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  <div className="flex items-center gap-2 px-4 py-2 rounded-lg" style={{
                    ...
                    <svg className="w-4 h-4" style={{ color: darkMode ? '#60a5fa' : '#3b82f6' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex gap-6">
                <div className="stat-card text-center px-6 py-4 rounded-xl" style={{
                  background: darkMode ? '#0f172a' : '#f1f5f9',
                  border: darkMode ? '1px solid #334155' : '1px solid #e5e7eb'
                }}>
          ...
          {/* TABS */}
          <div className="flex gap-6 mb-8 border-b-2" style={{
                      ...
                      <div className="mt-2.5 px-1">
                        ...
                        <div className="flex items-center justify-between gap-2 text-xs">
                          <div className="flex items-center gap-1 flex-shrink-0">
                            ...
                            <span className="font-medium" style={{ color: darkMode ? '#94a3b8' : '#64748b' }}>{video.views || 0}</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          {activeTab === "about" && (
            <div className="max-w-3xl">
              <div className="rounded-2xl p-8" style={{
                ...
                <h2 className="text-2xl font-bold mb-6" style={{ color: darkMode ? '#f1f5f9' : '#0f172a' }}>
                  Account Information
                </h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 rounded-xl" style={{
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-base font-semibold" style={{ color: darkMode ? '#f1f5f9' : '#0f172a' }}>
                        {user.fullName}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl" style={{
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-base font-semibold font-mono" style={{ color: darkMode ? '#f1f5f9' : '#0f172a' }}>
                        {user._id}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8 pt-6 border-t" style={{
                  ...
                  <button className="w-full px-6 py-3 rounded-xl font-semibold transition-all flex items-center justify-center gap-2" style={{
